      ...
      <el-form label-width="120px">
        <div class="row-form">
          <el-form-item label="问题" required>
            <el-input v-model="editParams.title" placeholder="请填写问题"></el-input>
          </el-form-item>
        </div>
        <div class="row-form">
        ...
        <div class="row-form" v-show=" editParams.typeId === ''">
          <el-form-item label="上传文件" required>
            <div class="add_solutions-dialog-upload">
              <div
                class="add_solutions-dialog-upload-list"
                :class="{'last_no_bottom': !editParams.typeId}"
              ...
              <el-upload
                v-show="editParams.typeId === 'store' || editParams.fileContent.length === 0"
                action="/api/ueditor/index?action=uploadfile&encode=utf-8"
                :show-file-list="false"
                :before-upload="handleFileBeforeUpload"
                :on-success="(response, file, fileList) => handleFileSuccess(file)"
...
export default class Edit extends Vue {
  @Prop({ type: Number }) readonly solutionId!: number;
  ...
  showDownBtn: boolean = true;

  isLoading: boolean = true;

  editParams: QASolutionDetail = {
    solutionId: null,
    title: '',
    typeId: '',
    collegeId: null,
  ...
  async created() {
    await Promise.all([
      (async () => {
        const qASolutionDetailRes = await Network.fetch<QASolutionDetailRes>(
          'qASolutionDetail',
          { solutionId: this.solutionId },
        );
        this.editParams = qASolutionDetailRes.data.retData.tipsInfo;
        // this.defaultTitle = qASolutionDetailRes.data.retData.tipsInfo.title;
        // this.defaultContent = qASolutionDetailRes.data.retData.tipsInfo.content;
        if (this.editParams.fileContent.length === 0) this.showDownBtn = false;
