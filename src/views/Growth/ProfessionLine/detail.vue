<template>
  <div class="profession_detail">
    ...
    <router-link class="back" :to="{name: 'professionLine'}">返回列表</router-link>

    <div class="profession_detail-card">
      <div class="profession_detail-card-header">
      ...
      <div class="profession_detail-card-content" v-html="tipsInfo.content"></div>
    </div>
  </div>
</template>
<script lang="ts">
